...
- `ios-device-archive`: build an unsigned Release archive for a physical iOS device, version 2.0.0/build 7. It is not installable and must be provisioned, signed, validated and uploaded through Apple’s supported tools.
